...
interface DiscoveryProviderListener {
     ...
     */
    suspend fun onServiceAdded(provider: DiscoveryProvider, serviceDescription: ServiceDescription)
     ...
     */
    suspend fun onServiceRemoved(provider: DiscoveryProvider, serviceDescription: ServiceDescription?)
     ...
     */
    fun onServiceDiscoveryFailed(provider: DiscoveryProvider, error: ServiceCommandError)
}
