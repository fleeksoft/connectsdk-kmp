 ...
 */
interface ConnectableDeviceStore {
    /**
     ...
     */
    suspend fun addDevice(device: ConnectableDevice)
     ...
     */
    suspend fun removeDevice(device: ConnectableDevice)
     ...
     */
    suspend fun updateDevice(device: ConnectableDevice)
     ...
     */
    fun getStoredDevices(): JsonObject
     ...
     */
    fun getDevice(uuid: String?): ConnectableDevice?
     ...
     */
    fun getServiceConfig(serviceDescription: ServiceDescription?): ServiceConfig?
