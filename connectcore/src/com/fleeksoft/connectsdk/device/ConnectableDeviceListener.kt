 ...
 */
interface ConnectableDeviceListener {
    /**
     ...
     */
    fun onDeviceReady(device: ConnectableDevice)
     ...
     */
    fun onDeviceDisconnected(device: ConnectableDevice)
    ...
    suspend fun onCapabilityUpdated(
        device: ConnectableDevice,
        added: List<String>,
        removed: List<String>
    )
     ...
     */
    fun onConnectionFailed(device: ConnectableDevice, error: ServiceCommandError)
}
